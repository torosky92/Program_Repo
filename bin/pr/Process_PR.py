...
class ProcessPR(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def findLote(self):
        ...
        self.CB1_4.setReadOnly(False)
        # ______________  Find Provider, Reference and presentation through Lote  ______________ #
        PRO, REF, PRES = findMPR.FindObjMPR(str(self.Proceso.currentText()), str(self.MAQ_3.currentText()))
        # ______________  Find code bar in a Base Data  ______________ #
        CB = findMPPR.FindObjMPPR(PRO, PRES, str(self.Proceso.currentText()), str(self.MAQ_3.currentText()))
