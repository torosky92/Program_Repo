...
class SQLMPR(Base):
   ...
   def UpdateMPR(TABLA: str, REMISION: str, DATO_MOD, Value):
      ...
      if DATO_MOD == Settings.Var_Comp26(): session.query(SQLMPR).filter_by(Ref2=valueRef).update({SQLMPR.Ref2: Value})
      elif DATO_MOD == Settings.Var_Comp15(): session.query(SQLMPR).filter_by(Worker=ValueWork).update({SQLMPR.Worker: Value})
      elif DATO_MOD == Settings.Var_Comp14(): session.query(SQLMPR).filter_by(Provider=ValueProv).update({SQLMPR.Provider: Value})
      elif DATO_MOD == Settings.Var_Comp13(): session.query(SQLMPR).filter_by(Reference=ValueReference).update({SQLMPR.Reference: Value})
      elif DATO_MOD == Settings.Var_Comp12(): session.query(SQLMPR).filter_by(Presentation=ValuePres).update({SQLMPR.Presentation: Value})
      elif DATO_MOD == Settings.Var_Comp2(): session.query(SQLMPR).filter_by(Num_Rem=ValueRem).update({SQLMPR.Num_Rem: Value})
      elif DATO_MOD == Settings.Var_Comp3(): session.query(SQLMPR).filter_by(Num_Pre=ValueNunPre).update({SQLMPR.Num_Pre: Value})
      elif DATO_MOD == Settings.Var_Comp4(): session.query(SQLMPR).filter_by(Total_Weight=ValueTotalW).update({SQLMPR.Total_Weight: Value})
      elif DATO_MOD == Settings.Var_Comp5(): session.query(SQLMPR).filter_by(Total_WeightR=ValueTotalWR).update({SQLMPR.Total_WeightR: Value})
      elif DATO_MOD == Settings.Var_Comp19(): session.query(SQLMPR).filter_by(Initial_Date=ValueInDate).update({SQLMPR.Initial_Date: Value})
      elif DATO_MOD == Settings.Var_Comp20(): session.query(SQLMPR).filter_by(Final_Date=ValueFinalDate).update({SQLMPR.Final_Date: Value})
      elif DATO_MOD == Settings.Var_Comp1(): session.query(SQLMPR).filter_by(CodeB=ValueCode).update({SQLMPR.CodeB: Value})
      elif DATO_MOD == Settings.Var_Comp6(): session.query(SQLMPR).filter_by(Num_Coils=ValueCoils).update({SQLMPR.Num_Coils: Value})
      elif DATO_MOD == Settings.Var_Comp7(): session.query(SQLMPR).filter_by(Num_CoilsR=ValuerCoilsR).update({SQLMPR.Num_CoilsR: Value})
      session.commit()
      session.close()
